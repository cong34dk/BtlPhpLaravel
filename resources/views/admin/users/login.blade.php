...
<div class="login-box">
  <div class="login-logo">
    <p href="/assets/adminpage/index2.html"><b>Admin</b></p>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      @include('admin.alert')
      <form action="{{ url('admin/users/login/store') }}" method="post">
      @csrf
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Username" autocomplete="off" name="username" autofocus>
